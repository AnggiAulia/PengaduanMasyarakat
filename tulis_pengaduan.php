    ...
    <div class="card-body">
      <form action="simpan_pengaduan.php" method="post" class="form-horizontal" enctype="multipart/form-data">
        <div class="form-group cols-sm-6">
          ...
          <input type="date" name="tgl_pengaduan" value="<?php echo date('d/m/Y'); ?>" class="form-control">
        </div>
        <div class="form-group cols-sm-6">
        ...
        <div class="form-group cols-sm-6">
          ...
          <input type="file" name="foto" class="form-control" accept=".jpg, .jpeg, .png"><font color="red">*unggah file berjenis : .jpg, .jpeg, .png</font>
        </div>
        <div class="form-group cols-sm-6">
